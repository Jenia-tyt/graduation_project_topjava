...
public class MenuDataTest {
    ...
    private static final Menu menu2 = new Menu (7, r1, LocalDate.of(2020, Month.JANUARY, 20), "сидр 3 макороны 2 суп 3", 0);
    private static final Menu menu3 = new Menu (8, r1, LocalDate.of(2020, Month.FEBRUARY, 29), "пиво 2 макороны 2 суп 3", 0);
    public static final List<Menu> MENU_OF_REST = List.of(menu1, menu2, menu3);

    private static final Menu m2 = new Menu(9, r2, LocalDate.of(2020, Month.JANUARY, 30), "чай 2 гречка 4 щи 9", 0);
    private static final Menu m3 = new Menu(10, r3, LocalDate.of(2020, Month.JANUARY, 30), "кофе 3 кус кус 0.6 суп из семи залуп 4", 0);
    private static final Menu m4 = new Menu(11, r5, LocalDate.of(2020, Month.JANUARY, 30), "вода 100 хлебная мякиш 2 вода с хлебными крошками 3", 0);
    private static final Menu m5 = new Menu(12, r4, LocalDate.of(2020, Month.JANUARY, 30), "шампанское \"кристал\" 1 устрицы 1 черная икра 3", 0);
    public static final List<Menu> ALL_MENU_OF_DATE_MENU_DATE = List.of(menu1, m2, m3, m4, m5);

    private static final Menu m6 = new Menu(14, r4, LocalDate.now(), "шампанское \"кристал\" 1 устрицы 1 черная икра 3", 0);
