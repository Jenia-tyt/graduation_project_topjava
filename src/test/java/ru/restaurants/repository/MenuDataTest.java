...
public class MenuDataTest {
    ...
    public static final Menu m3 = new Menu(10, r3, LocalDate.of(2020, Month.JANUARY, 30), "кофе 3 кус кус 0.6 суп из семи залуп 4", 0);
    public static final Menu m4 = new Menu(11, r5, LocalDate.of(2020, Month.JANUARY, 30), "вода 100 хлебная мякиш 2 вода с хлебными крошками 3", 0);
    ...
    public static final Menu m6 = new Menu(14, r4, LocalDate.now(), "шампанское \"кристал\" 1 устрицы 1 черная икра 3", 0);
