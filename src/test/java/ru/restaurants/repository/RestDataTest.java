...
public class RestDataTest {
    ...
    public static final Restaurant r1 = new Restaurant(REST_ID, "restaurant1", 0);
    public static final Restaurant r2 = new Restaurant(REST_ID+1,"restaurant2", 10);
    public static final Restaurant r3 = new Restaurant(REST_ID+2,"restaurant3", 3);
    public static final Restaurant r4 = new Restaurant(REST_ID+4,"restaurant4", -10);
    public static final Restaurant r5 = new Restaurant(REST_ID+3,"restaurant5",  99);
