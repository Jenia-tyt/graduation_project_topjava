...
public class VoteDataTest {
    ...
    public static final Vote VOTE = new Vote(VOTE_ID, USER_WITH_ID_15, LocalDate.of(2020,01, 30), 11);
    private static final Vote VOTE_2 = new Vote(19, USER_WITH_ID_17, LocalDate.of(2020,01, 30), 12);
    private static final Vote VOTE_3 = new Vote(20, USER_WITH_ID_15, LocalDate.now(), 14);
    ...
    public static final Vote NEW_VOTE = new Vote(null, USER_WITH_ID_15, LocalDate.of(2044,01, 30), 11);

    public static final Vote VOTE_TO_DAY = new Vote(20, USER_WITH_ID_15, LocalDate.now(), 14);
