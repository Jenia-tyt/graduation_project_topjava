...
@Controller
@RequestMapping(value = UIRegisteredController.URL, produces = MediaType.APPLICATION_JSON_VALUE)
public class UIRegisteredController {
    ...
    public UIRegisteredController(VoteService voteService, UserService userService) {
